...
# firebase_custom_domain, enable_sql_read_replica, backend_max_instances) — tracked in git
# (unlike terraform.tfvars) because .github/workflows/deploy.yml reads this exact file on every
# push to main, so it needs to reflect reality for CI to apply the right thing.
